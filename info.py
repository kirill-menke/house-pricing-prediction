...
def plot_feature_distribution(data, num=9):
    ...
    features = ["area_total", "area_kitchen", "area_living", "floor", "ceiling", "latitude", "longitude", "constructed", "stories"]
...
def draw_boxplots(data):
    sns.boxplot(np.log1p(data['area_total']))
    plt.show()
